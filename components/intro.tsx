        ...
        <section id='home' className='mb-28 max-w-[50rem] scroll-mt-[100rem] text-center sm:mb-0' ref={ref}>
            <div className='flex items-center justify-center'>
                <div className='relative'>
                    ...
                    <motion.span
                        className='absolute bottom-3 right-0 text-4xl'
                        initial={{ opacity: 0, scale: 0 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ type: 'spring', stiffness: 125, delay: 0.2, duration: 2 }}
                    >
                        👋
                    </motion.span>
                </div>
            ...
            >
                ...
                <span className='font-bold'>full-stack developer</span> with <span className='font-bold'>7 years</span>{' '}
