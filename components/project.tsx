...
export default function Project({ title, description, tags, imageUrl }: ProjectProps) {
    ...
    /*
     * 'offset' defines the start and end progress values for the scroll offset.
     * ['start end'] -> Animation Start point -> means when start of the target element meets end of the container (page)
     * ['1.33 end'] -> Animation End point -> means when 1.33 times of the target element meets end of the container (page)
     * This allows controlling the range of scroll progress mapped to the
     * animation.
     */
